...
CREATE TABLE IF NOT EXISTS `famillie` (
  ...
  `rang2`  varchar(20) NOT NULL DEFAULT '',
  `rang3`  varchar(20) NOT NULL DEFAULT '',
  `rang4`  varchar(20) NOT NULL DEFAULT '',
  `rang5`  varchar(20) NOT NULL DEFAULT '',
  `rang6`  varchar(20) NOT NULL DEFAULT '',
  `rang7`  varchar(20) NOT NULL DEFAULT '',
  `rang8`  varchar(20) NOT NULL DEFAULT '',
  `rang9`  varchar(20) NOT NULL DEFAULT '',
  `rang10` varchar(20) NOT NULL DEFAULT '',
  `rang11` varchar(20) NOT NULL DEFAULT '',
  `rang12` varchar(20) NOT NULL DEFAULT '',
  `rang13` varchar(20) NOT NULL DEFAULT '',
  `rang14` varchar(20) NOT NULL DEFAULT '',
  PRIMARY KEY (`name`),
  KEY `stad` (`stad`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
