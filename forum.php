...
$nr = mysql_query("SELECT id,user,subject,message,date FROM forum_reacties WHERE topic_id = ".addslashes($_GET['topic'])) or die(mysql_error());
  ...
  <?php if($_GET['p'] == 0) {
    ...
    $object['message'] = preg_replace("~\[/b\]~i","</b>",$object['message']);
    $object['message'] = preg_replace("~\[i\]~i","<i>",$object['message']);
    $object['message'] = preg_replace("~\[/i\]~i","</i>",$object['message']);
    $object['message'] = preg_replace("~\[s\]~i","<s>",$object['message']);
    $object['message'] = preg_replace("~\[/s\]~i","</s>",$object['message']);
    $object['message'] = preg_replace("~\[move\]~i","<marquee>",$object['message']);
    $object['message'] = preg_replace("~\[/move\]~i","</marquee>",$object['message']);
    $object['message'] = preg_replace("~\[u\]~i","<u>",$object['message']);
    $object['message'] = preg_replace("~\[/u\]~i","</u>",$object['message']);
    $object['message'] = preg_replace("~\[list\]~i","<UL>",$object['message']);
    $object['message'] = preg_replace("~\[/list\]~i","</UL>",$object['message']);
    $object['message'] = preg_replace("~\[\*\]~i","<LI>",$object['message']);
    $object['message'] = preg_replace("~\[small\]~i","<font size=1>",$object['message']);
