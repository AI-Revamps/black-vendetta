...
if($message = mysql_fetch_object($dbres)) {
  ...
  $message->message		= preg_replace('/(http:\/\/\S+)/','<a href="$1" target=\"_blank\">$1</a>',$message->message);
    ...
    $message->message = preg_replace("~\(b\)~i","<img src=images/img/biere.gif>",$message->message);
...
$message->message = preg_replace("~\(B\)~i","<img src=images/img/biere.gif>",$message->message);
	$message->message = preg_replace("~:\)~i","<img src=images/img/sourire.gif>",$message->message);
	$message->message = preg_replace("~:-\)~i","<img src=images/img/sourire.gif>",$message->message);
	$message->message = preg_replace("~:d~i","<img src=images/img/content.gif>",$message->message);
	$message->message = preg_replace("~:-D~i","<img src=images/img/content.gif>",$message->message);
	$message->message = preg_replace("~:-O~i","<img src=images/img/OH-2.gif>",$message->message);
	$message->message = preg_replace("~:o~i","<img src=images/img/OH-1.gif>",$message->message);
	$message->message = preg_replace("~:p~i","<img src=images/img/langue.gif>",$message->message);
	$message->message = preg_replace("~:-P~i","<img src=images/img/langue.gif>",$message->message);
	$message->message = preg_replace("~\;\)~i","<img src=images/img/clin-oeuil.gif>",$message->message);
	$message->message = preg_replace("~\;-\)~i","<img src=images/img/clin-oeuil.gif>",$message->message);
	$message->message = preg_replace("~:\(~i","<img src=images/img/triste.gif>",$message->message);
	$message->message = preg_replace("~:-\(~i","<img src=images/img/triste.gif>",$message->message);
	$message->message = preg_replace("~:\|~i","<img src=images/img/OH-3.gif>",$message->message);
	$message->message = preg_replace("~:-\|~i","<img src=images/img/OH-3.gif>",$message->message);
	$message->message = preg_replace("~:\'\(~i","<img src=images/img/pleure.gif>",$message->message);
	$message->message = preg_replace("~\(h\)~i","<img src=images/img/cool.gif>",$message->message);
	$message->message = preg_replace("~\(H\)~i","<img src=images/img/cool.gif>",$message->message);
	$message->message = preg_replace("~:-@~i","<img src=images/img/enerve1.gif>",$message->message);
	$message->message = preg_replace("~:@~i","<img src=images/img/enerve2.gif>",$message->message);
	$message->message = preg_replace("~:s~i","<img src=images/img/roll-eyes.gif>",$message->message);
	$message->message = preg_replace("~:-S~i","<img src=images/img/roll-eyes.gif>",$message->message);
	$message->message = preg_replace("~\(k\)~i","<img src=images/img/bouche.gif>",$message->message);
	$message->message = preg_replace("~\(K\)~i","<img src=images/img/bouche.gif>",$message->message);
	$message->message = preg_replace("~\(l\)~i","<img src=images/img/coeur.gif>",$message->message);
	$message->message = preg_replace("~\(L\)~i","<img src=images/img/coeur.gif>",$message->message);
	$message->message = preg_replace("~\(u\)~i","<img src=images/img/coeur-brise.gif>",$message->message);
	$message->message = preg_replace("~\(U\)~i","<img src=images/img/coeur-brise.gif>",$message->message);
	$message->message = preg_replace("~\;-P~i","<img src=images/img/clin-oeuil-langue.gif>",$message->message);
	$message->message = preg_replace("~\;p~i","<img src=images/img/clin-oeuil-langue.gif>",$message->message);
	$message->message = preg_replace("~\(y\)~i","<img src=images/img/pouce-oui.gif>",$message->message);
	$message->message = preg_replace("~\(Y\)~i","<img src=images/img/pouce-oui.gif>",$message->message);
	$message->message = preg_replace("~\(n\)~i","<img src=images/img/pouce-non.gif>",$message->message);
	$message->message = preg_replace("~\(N\)~i","<img src=images/img/pouce-non.gif>",$message->message);
	$message->message = preg_replace("~\(6\)~i","<img src=images/img/diable.gif>",$message->message);
	$message->message = preg_replace("~\(d\)~i","<img src=images/img/drink.gif>",$message->message);
	$message->message = preg_replace("~\(D\)~i","<img src=images/img/drink.gif>",$message->message);
	$message->message = preg_replace("~_o_~i","<img src=images/img/worship.gif>",$message->message);
	$message->message = preg_replace("~\(g\)~i","<img src=images/img/gun.gif>",$message->message);
	$message->message = preg_replace("~\(G\)~i","<img src=images/img/guns.gif>",$message->message);
