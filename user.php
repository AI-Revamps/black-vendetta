...
if (!$user) { echo "Deze gebruiker bestaat niet."; exit; }
	...
	$info = preg_replace("~\(b\)~i","<img src=http://members.lycos.nl/js6287/chat/img/biere.gif>",$info);
	$info = preg_replace("~\(B\)~i","<img src=http://members.lycos.nl/js6287/chat/img/biere.gif>",$info);
	$info = preg_replace("~:\)~i","<img src=http://members.lycos.nl/js6287/chat/img/sourire.gif>",$info);
	$info = preg_replace("~:-\)~i","<img src=http://members.lycos.nl/js6287/chat/img/sourire.gif>",$info);
	$info = preg_replace("~:d~i","<img src=http://members.lycos.nl/js6287/chat/img/content.gif>",$info);
	$info = preg_replace("~:-D~i","<img src=http://members.lycos.nl/js6287/chat/img/content.gif>",$info);
	$info = preg_replace("~:-O~i","<img src=http://members.lycos.nl/js6287/chat/img/OH-2.gif>",$info);
	$info = preg_replace("~:o~i","<img src=http://members.lycos.nl/js6287/chat/img/OH-1.gif>",$info);
	$info = preg_replace("~:p~i","<img src=http://members.lycos.nl/js6287/chat/img/langue.gif>",$info);
	$info = preg_replace("~:-P~i","<img src=http://members.lycos.nl/js6287/chat/img/langue.gif>",$info);
	$info = preg_replace("~\;\)~i","<img src=http://members.lycos.nl/js6287/chat/img/clin-oeuil.gif>",$info);
	$info = preg_replace("~\;-\)~i","<img src=http://members.lycos.nl/js6287/chat/img/clin-oeuil.gif>",$info);
	$info = preg_replace("~:\(~i","<img src=http://members.lycos.nl/js6287/chat/img/triste.gif>",$info);
	$info = preg_replace("~:-\(~i","<img src=http://members.lycos.nl/js6287/chat/img/triste.gif>",$info);
	$info = preg_replace("~:\|~i","<img src=http://members.lycos.nl/js6287/chat/img/OH-3.gif>",$info);
	$info = preg_replace("~:-\|~i","<img src=http://members.lycos.nl/js6287/chat/img/OH-3.gif>",$info);
	$info = preg_replace("~:\'\(~i","<img src=http://members.lycos.nl/js6287/chat/img/pleure.gif>",$info);
	$info = preg_replace("~\(h\)~i","<img src=http://members.lycos.nl/js6287/chat/img/cool.gif>",$info);
	$info = preg_replace("~\(H\)~i","<img src=http://members.lycos.nl/js6287/chat/img/cool.gif>",$info);
	$info = preg_replace("~:-@~i","<img src=http://members.lycos.nl/js6287/chat/img/enerve1.gif>",$info);
	$info = preg_replace("~:@~i","<img src=http://members.lycos.nl/js6287/chat/img/enerve2.gif>",$info);
	$info = preg_replace("~:s~i","<img src=http://members.lycos.nl/js6287/chat/img/roll-eyes.gif>",$info);
	$info = preg_replace("~:-S~i","<img src=http://members.lycos.nl/js6287/chat/img/roll-eyes.gif>",$info);
	$info = preg_replace("~\(k\)~i","<img src=http://members.lycos.nl/js6287/chat/img/bouche.gif>",$info);
	$info = preg_replace("~\(K\)~i","<img src=http://members.lycos.nl/js6287/chat/img/bouche.gif>",$info);
	$info = preg_replace("~\(l\)~i","<img src=http://members.lycos.nl/js6287/chat/img/coeur.gif>",$info);
	$info = preg_replace("~\(L\)~i","<img src=http://members.lycos.nl/js6287/chat/img/coeur.gif>",$info);
	$info = preg_replace("~\(u\)~i","<img src=http://members.lycos.nl/js6287/chat/img/coeur-brise.gif>",$info);
	$info = preg_replace("~\(U\)~i","<img src=http://members.lycos.nl/js6287/chat/img/coeur-brise.gif>",$info);
	$info = preg_replace("~\;-P~i","<img src=http://members.lycos.nl/js6287/chat/img/clin-oeuil-langue.gif>",$info);
	$info = preg_replace("~\;p~i","<img src=http://members.lycos.nl/js6287/chat/img/clin-oeuil-langue.gif>",$info);
	$info = preg_replace("~\(y\)~i","<img src=http://members.lycos.nl/js6287/chat/img/pouce-oui.gif>",$info);
	$info = preg_replace("~\(Y\)~i","<img src=http://members.lycos.nl/js6287/chat/img/pouce-oui.gif>",$info);
	$info = preg_replace("~\(n\)~i","<img src=http://members.lycos.nl/js6287/chat/img/pouce-non.gif>",$info);
	$info = preg_replace("~\(N\)~i","<img src=http://members.lycos.nl/js6287/chat/img/pouce-non.gif>",$info);
	$info = preg_replace("~\(6\)~i","<img src=http://members.lycos.nl/js6287/chat/img/diable.gif>",$info);
	$info = preg_replace("~\(d\)~i","<img src=http://members.lycos.nl/js6287/chat/img/drink.gif>",$info);
	$info = preg_replace("~\(D\)~i","<img src=http://members.lycos.nl/js6287/chat/img/drink.gif>",$info);
	$info = preg_replace("~_o_~i","<img src=http://members.lycos.nl/js6287/chat/img/worship.gif>",$info);
	$info = preg_replace("~\(g\)~i","<img src=http://members.lycos.nl/js6287/chat/img/gun.gif>",$info);
	$info = preg_replace("~\(G\)~i","<img src=http://members.lycos.nl/js6287/chat/img/guns.gif>",$info);
